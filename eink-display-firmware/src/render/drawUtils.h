...
public:
    ...
    static uint16_t drawString(uint8_t *imageData, uint16_t x, uint16_t y, const char *str, const ProportionalFont *font, Color color);
    static uint16_t drawChar(uint8_t *imageData, uint16_t x, uint16_t y, char c, const ProportionalFont *font, Color color);
